...
function App() {
  ...
  return (
    ...
    <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2 m-4 rounded-sm ">
      <div className="flex flex-wrap justify-center gap-3 p-1 shadow-lg bg-white px-3 py-2 rounded-xl ">
